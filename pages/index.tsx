                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                                <div>
                                    ...
                                    <div className="flex gap-3">
                                        <a href="https://github.com/caviraoss/openmemory" className="w-9 h-9 bg-slate-900/50 hover:bg-slate-800/60 border border-slate-700/40 hover:border-slate-600/60 rounded-lg flex items-center justify-center transition-all">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2.5">
                                        <li><a href="https://github.com/caviraoss/openmemory" className="text-sm text-gray-500 hover:text-white transition-colors">GitHub</a></li>
                                        <li><a href="https://github.com/caviraoss/openmemory/issues" className="text-sm text-gray-500 hover:text-white transition-colors">Issues</a></li>
                                        <li><a href="https://github.com/caviraoss/openmemory/discussions" className="text-sm text-gray-500 hover:text-white transition-colors">Discussions</a></li>
                                        <li><a href="https://github.com/caviraoss/openmemory/blob/main/LICENSE" className="text-sm text-gray-500 hover:text-white transition-colors">License</a></li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2.5">
                                        <li><a href="https://github.com/caviraoss/openmemory/stargazers" className="text-sm text-gray-500 hover:text-white transition-colors">Star on GitHub</a></li>
                                        <li><a href="https://github.com/caviraoss/openmemory/fork" className="text-sm text-gray-500 hover:text-white transition-colors">Fork</a></li>
                                        <li><a href="https://github.com/caviraoss/openmemory/contributors" className="text-sm text-gray-500 hover:text-white transition-colors">Contributors</a></li>
                                    </ul>
                                </div>
                            </div>
